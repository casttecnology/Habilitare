...
function atualizaQuestao()
{
	if(requisicao.readyState == 4)
	{
		if(requisicao.status == 200)
		{
			...
			document.getElementById("perguntas").innerHTML = '<div style="font-size:20px; padding:50px 0px 30px 50px">'+str[1]+'</div>';
			document.getElementById("respostas").innerHTML = '<div style="font-size:16px; padding:20px 0px 30px 50px"><label for="resposta1"><input type="radio" value="1" id="resposta1" name="resposta" />'+str[2]+'</label></div><div style="font-size:16px; padding:20px 0px 30px 50px"><label for="resposta2"><input type="radio" value="2" id="resposta2" name="resposta" />'+str[3]+'</label></div><div style="font-size:16px; padding:20px 0px 30px 50px"><label for="resposta3"><input type="radio" value="3" id="resposta3" name="resposta" />'+str[4]+'</label></div><div style="font-size:16px; padding:20px 0px 30px 50px"><label for="resposta4"><input type="radio" value="4" id="resposta4" name="resposta" />'+str[5]+'</label></div>';
